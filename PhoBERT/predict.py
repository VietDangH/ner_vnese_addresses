...
"""Inference entry point: tag addresses with a trained model.
    ...
    # single string
    python -m vn_ner.predict --model_dir ner_model \
    ...
    # interactive REPL
    python -m vn_ner.predict --model_dir ner_model --interactive
"""
...
from .segment import get_backend
...
def parse_args():
    p = argparse.ArgumentParser(description="Predict address entities with a PhoBERT NER model")
...
def main():
    ...
    print(f"Loaded. Segmentation backend: {get_backend()}")
